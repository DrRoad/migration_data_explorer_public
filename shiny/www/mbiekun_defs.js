...
var mbiekun_tour = function(){
   ...
   defs.work_pop = {
      ...
      schedule: [
         ...
         ["#BetterCSVs_hc-ts", "<noscroll><moveonly>"],
         ...
         [undefined, undefined, "We can disable the filter to Germany, so we can compare the different Nationalities."],
         [".filsel[value=" + JSON.stringify(JSON.stringify(["Germany"])) + "]", "<noscroll><focusonly>"],
         [".filsel[value=" + JSON.stringify(JSON.stringify(["Germany"])) + "] ~ .filsel-toggle", "<noscroll>"],
